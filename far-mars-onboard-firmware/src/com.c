...
//Table of crc codes for the CRCCCITT method below it.
...
/** Best GUESS of functionality from code on AutomationWiki: http://automationwiki.com/index.php/CRC-16-CCITT
 *
 * @brief Error detection method that lacks additional transmission overhead
 *
 * @param[in]  *data   Pointer to the array of bytes
 * @param[in]  length  Size of the data array
 *
 * @return Returns the CRC error code
 */
